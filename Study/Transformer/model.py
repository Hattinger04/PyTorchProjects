...
class PositionalEncoding(nn.Module): 
    ...
    def forward(self, x):
        ...
        x = x + (self.pe[:, :x.shape[1], :]).requires_grad(False) # do not learn this function 
...
class MultiHeadAttentionBlock(nn.Module): 
    ...
    def attention(query, key, value, mask, dropout: nn.Dropout): 
        ...
        return (attention_scores @ value), attention_scores # second return value for visulaization
